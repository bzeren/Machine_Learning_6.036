...
#-------------------------------------------------------------------------------
# best_theta = p1.average_passive_aggressive(test_bow_features, test_labels, 20, 1)
...
# (train_accuracy, test_accuracy) = p1.average_passive_aggressive_accuracy(train_final_features,test_final_features,train_labels,test_labels,T=20,L=1)
