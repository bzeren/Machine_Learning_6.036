...
def check_average_passive_aggressive(student_module):
    try:
        res = student_module.average_passive_aggressive(test_feature_matrix, test_labels, 5)
        if isinstance(res, tuple):
...
if __name__ == '__main__':
    ...
    code_checks = [check_hinge_loss, check_perceptron_single_step_update, check_perceptron,
     check_passive_aggressive_single_step_update, check_average_perceptron, check_classify,
     check_perceptron_accuracy, check_average_passive_aggressive_accuracy]
