...
# theta, costFunctionHistory = softmaxRegression(train_pca, trainY, alpha= 0.3, lambdaFactor = 1.0e-4, k = 10, numIterations = 150)
# testError = computeTestError(test_pca, testY, theta)
# print testError
